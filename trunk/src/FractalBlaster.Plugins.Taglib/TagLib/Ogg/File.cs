...
#region Private Fields
		...
		/// <summary>
		///   Contains the tags for the path.
		/// </summary>
...
#region Private Methods
		...
		/// <summary>
		///    Reads the path until all streams have finished their
		...
		///    /> object containing mStream serial numbers as the keys
...
#region Private Properties
		...
		/// <summary>
		///    Gets the last page header in the path.
		/// </summary>
		/// <value>
		///    A <see cref="PageHeader" /> object containing the last
		///    page header in the path.
		/// </value>
		/// <remarks>
		///    The last page header is used to determine the last
		///    absolute granular position of a mStream so the duration
		///    can be calculated.
		/// </remarks>

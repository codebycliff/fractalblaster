...
#region Constructors
		...
		/// </summary>
		/// <param name="page">
		///    The first <see cref="Page" /> object of the mStream to be
...
#region Public Methods
		...
		/// <summary>
		///    Reads the next logical page in the mStream.
		/// </summary>
		/// <param name="page">
		...
		/// <summary>
		///    Gets the duration of the mStream represented by the
		///    current instance.
		/// </summary>
		...
		///    of the mStream represented by the current instance.
		/// </returns>
...
#region Public Properties
		...
		/// <summary>
		///    Gets the codec object used to interpret the mStream

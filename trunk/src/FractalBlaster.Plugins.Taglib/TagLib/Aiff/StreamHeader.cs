//
// StreamHeader.cs: Provides support for reading Apple's AIFF mStream
// properties.
//
// Author:
//   Helmut Wahrmann
...
namespace TagLib.Aiff
{
	...
	///    support for reading Apple's AIFF mStream properties.
	/// </summary>
	public struct StreamHeader : IAudioCodec, ILosslessAudioCodec
	{
		...
		/// <summary>
		///    The identifier used to recognize a AIFF path.
		///    Altough an AIFF path start with "FORM2, we're interested

//
// FileTypes.cs: Provides a mechanism for registering path classes and mime-
...
namespace TagLib {
	/// <summary>
	///    This static class provides a mechanism for registering path
	...
	public static class FileTypes
	{
		...
		/// <summary>
		///    Contains a static array of path types contained in the
		///    TagLib# assembly.
		/// </summary>
		/// <remarks>
		...
		///    and path classes used by <see cref="File.Create(string)"
		///    />.
		/// </summary>
		/// <value>

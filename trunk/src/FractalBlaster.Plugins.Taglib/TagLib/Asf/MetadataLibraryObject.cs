...
namespace TagLib.Asf {
		...
		IEnumerable<DescriptionRecord>
	{
		...
		/// <summary>
		///    Removes all records with a given language, mStream, and
		...
		///    A <see cref="ushort" /> value containing the mStream
		...
		/// <summary>
		///    Gets all records with a given language, mStream, and any
		...
		///    mStream, and name, removing the existing matching records.
		/// </summary>
		/// <param name="languageListIndex">
		///    A <see cref="ushort" /> value containing the language

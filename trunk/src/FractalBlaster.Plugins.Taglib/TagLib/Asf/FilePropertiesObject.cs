...
namespace TagLib.Asf {
	...
	public class FilePropertiesObject : Object
	{
		...
		/// <summary>
		///    Contains the GUID for the path.
		/// </summary>
		private System.Guid file_id;
		
		/// <summary>
		///    Contains the path size.
		/// </summary>
		...
		/// <summary>
		///    Contains the maximum bitrate of the path.
		/// </summary>
		...
		///    from a specified position in a specified path.
		/// </summary>
		/// <param name="path">
		///    A <see cref="Asf.File" /> object containing the path from
		...
		/// <summary>
		///    Gets the GUID for the path described by the current
		///    instance.
		/// </summary>
		/// <value>
		///    A <see cref="System.Guid" /> value containing the GUID
		///    for the path described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the size of the path described by the current
		///    instance.
		/// </summary>
		/// <value>
		///    A <see cref="ulong" /> value containing the size of the
		///    path described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the creation date of the path described by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="DateTime" /> value containing the creation
		///    date of the path described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the number of data packets in the path described by
		///    the current instance.
		/// </summary>
		/// <value>
		///    A <see cref="ulong" /> value containing the number of
		///    data packets in the path described by the current
		///    instance.
		/// </value>
		...
		/// <summary>
		///    Gets the play duration of the path described by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="TimeSpan" /> value containing the play
		///    duration of the path described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the send duration of the path described by the
		///    current instance.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the pre-roll of the path described by the current
		///    instance.
		/// </summary>
		/// <value>
		///    A <see cref="ulong" /> value containing the pre-roll of
		///    the path described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the flags of the path described by the current
		///    instance.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the minimum data packet size of the path described
		///    by the current instance.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value containing the minimum data
		///    packet size of the path described by the current
		///    instance.
		/// </value>
		...
		/// <summary>
		///    Gets the maximum data packet size of the path described
		///    by the current instance.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the maximum bitrate of the path described by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value containing the maximum
		///    bitrate of the path described by the current instance.
		/// </value>

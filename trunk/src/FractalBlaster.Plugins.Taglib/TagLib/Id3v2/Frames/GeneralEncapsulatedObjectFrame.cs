...
namespace TagLib.Id3v2 {
	...
	///    used for storing files and other objects relevant to the path but
...
#region Private Fields
		...
		/// <summary>
		///    Contains the original path name.
		/// </summary>
...
#region Public Properties
		...
		/// <summary>
		///    Gets and sets the path name of the object stored in the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="string" /> containing the path name of the
		///    object stored in the current instance.
		/// </value>

...
#region Protected Methods
		...
		///    a specified position in a specified path.
		/// </summary>
		/// <param name="path">
		...
		///    header has been read from the path, otherwise the data
...
#region Private Methods
		...
		private void SetUfidText(string owner, string text) {
			...
			//If we have a real string, CreateRow to ByteVector and apply to frame
			if (!string.IsNullOrEmpty(text)) {

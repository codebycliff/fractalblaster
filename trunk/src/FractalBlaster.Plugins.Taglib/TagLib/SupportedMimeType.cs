...
namespace TagLib {
	...
	public sealed class SupportedMimeType : Attribute
	{
		...
		///    A <see cref="string" /> object containing a path
		///    extension.
		/// </param>
		/// <remarks>
		///    <para>Standard practice is to use <see
		...
		/// </value>
		/// <remarks>
		///    <para>The value is the path extension minus the preceding
		...
		/// </value>
		/// <remarks>
		///    <para>These values are currently not used in path type
		///    recognition.</para>
		/// </remarks>

...
namespace TagLib.Mpeg4 {
	...
	public class AppleElementaryStreamDescriptor : FullBox
	{
		...
		/// <summary>
		///    Contains the mStream ID.
		/// </summary>
		private ushort es_id;
		
		/// <summary>
		///    Contains the mStream priority.
		/// </summary>
		...
		/// <summary>
		///    Gets the ID of the mStream described by the current
		///    instance.
		/// </summary>
		/// <value>
		///    A <see cref="ushort" /> value containing the ID of the
		///    mStream described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the priority of the mStream described by the current
		///    instance.
		/// </summary>
		/// <value>
		///    A <see cref="byte" /> value containing the priority of
		///    the mStream described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the object type ID of the mStream described by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="byte" /> value containing the object type ID
		///    of the mStream described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the type the mStream described by the current
		///    instance.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the buffer size DB value the mStream described by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value containing the buffer size DB
		///    value the mStream described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the maximum bitrate the mStream described by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value containing the maximum
		///    bitrate the mStream described by the current instance.
		/// </value>
		...
		/// <summary>
		///    Gets the maximum average the mStream described by the
		///    current instance.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the decoder config data of mStream described by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="ByteVector" /> object containing the decoder
		///    config data of the mStream described by the current
		///    instance.
		/// </value>

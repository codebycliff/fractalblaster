...
namespace TagLib.Mpeg4 {
	...
	public class FileParser
	{
		...
		/// <summary>
		///    Contains the path to read from.
		/// </summary>
		private TagLib.File file;
		
		/// <summary>
		///    Contains the first header found in the path.
		/// </summary>
		...
		/// <summary>
		///    Contains the box headers from the top of the path to the
		///    "moov" box.
		/// </summary>
		...
		/// <summary>
		///    Contains the "stco" boxes found in the path.
		/// </summary>
		private List<Box> stco_boxes = new List<Box> ();
		
		/// <summary>
		///    Contains the "stsd" boxes found in the path.
		/// </summary>
		...
		///    cref="FileParser" /> for a specified path.
		/// </summary>
		/// <param name="path">
		...
		///    <paramref name="path" /> does not start with a
		///    "<c>ftyp</c>" box.
		/// </exception>
		...
		///    all parent boxes up to the top of the path as read by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="BoxHeader[]" /> containing the headers for
		///    the first "<c>moov</c>" box and its parent boxes up to
		///    the top of the path, in the order they appear, or <see
		...
		///    path and is used for estimating the invariant data
		///    portion of the path.
		/// </remarks>
		...
		/// <summary>
		///    Parses the path referenced by the current instance,

//
// BoxFactory.cs: Provides support for reading boxes from a path.
//
// Author:
...
namespace TagLib.Mpeg4 {
	/// <summary>
	///    This static class provides support for reading boxes from a path.
	/// </summary>
	public static class BoxFactory
	{
		/// <summary>
		///    Creates a box by reading it from a path given its header,
		///    parent header, handler, and index in its parent.
		/// </summary>
		/// <param name="path">
		///    A <see cref="TagLib.File" /> object containing the path
		///    to read from.
		/// </param>
		/// <param name="header">
		...
		/// <summary>
		///    Creates a box by reading it from a path given its
		///    position in the path, parent header, handler, and index
		///    in its parent.
		/// </summary>
		/// <param name="path">
		///    A <see cref="TagLib.File" /> object containing the path
		...
		///    position in <paramref name="path" /> to start reading.
		/// </param>
		/// <param name="parent">
		///    A <see cref="BoxHeader" /> object containing the header
		///    of the parent box.
		...
		/// <summary>
		///    Creates a box by reading it from a path given its
		///    position in the path and handler.
		/// </summary>
		/// <param name="path">
		///    A <see cref="TagLib.File" /> object containing the path
		///    to read from.

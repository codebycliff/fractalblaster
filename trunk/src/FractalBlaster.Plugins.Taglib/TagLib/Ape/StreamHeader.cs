//
// StreamHeader.cs: Provides support for reading Monkey's Audio APE mStream
// properties.
//
// Author:
//   Helmut Wahrmann
...
namespace TagLib.Ape {
	...
	///    support for reading Monkey's Audio APE mStream properties.
	/// </summary>
	public struct StreamHeader : IAudioCodec, ILosslessAudioCodec
	{
		...
		/// </summary>
		/// <remarks>
		///    This value is stored in bytes (4,5) of the path and is
		///    1000 times the actual version number, so 3810 indicates
		///    version 3.81.
		/// </remarks>
		private ushort version;
		
		// Ape Header (24 bytes) starting at Offest 52 into the path
		/// <summary>
		...
		*/
		...
		/// <summary>
		///    Contains the length of the audio mStream.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		///    The identifier used to recognize a WavPack path.
		/// </summary>
		/// <value>
		///    "MAC "
		/// </value>

...
#region Private Static Fields
		...
		///    this field will inform the path what encoding to use for
		///    the second string.
		/// </remarks>
...
#region Public Static Properties
		...
		///    problem would be apparent when moving a path from one
...
#region Operators
		...
		/// </summary>
		/// <param name="value">
		///    A <see cref="string" /> to CreateRow.
		/// </param>
		/// <returns>
		///    A new instance of <see cref="ByteVector" /> containing
...
#region Static Conversions
		...
		/// </summary>
		/// <param name="value">
		///    A <see cref="uint"/> value to CreateRow into bytes.
		/// </param>
		/// <param name="mostSignificantByteFirst">
		...
		/// </summary>
		/// <param name="value">
		///    A <see cref="ushort"/> value to CreateRow into bytes.
		/// </param>
		/// <param name="mostSignificantByteFirst">
		///    <see langword="true" /> if the most significant byte is
		///    to appear first (big endian format), or <see
		...
		/// </summary>
		/// <param name="value">
		///    A <see cref="ulong"/> value to CreateRow into bytes.
		/// </param>
		/// <param name="mostSignificantByteFirst">
		///    <see langword="true" /> if the most significant byte is
		///    to appear first (big endian format), or <see
		...
		///    reading in the contents of a specified path.
		/// </summary>
		/// <param name="path">
		...
		///    first data chunk from the read path.
		/// </param>
		/// <param name="copyFirstChunk">
		///    A <see cref="bool"/> value specifying whether or not to
		///    copy the first chunk of the path into <paramref
		///    name="firstChunk" />.
		/// </param>
		/// <returns>
		///    A <see cref="ByteVector"/> object containing the contents
		...
		/// <summary>
		///    Creates a new instance of <see cref="ByteVector" /> by
		///    reading in the contents of a specified path abstraction.
		/// </summary>
		/// <param name="abstraction">
		///    A <see cref="File.IFileAbstraction"/> object containing
		///    abstraction of the path to read.
		/// </param>
		/// <returns>
		///    A <see cref="ByteVector"/> object containing the contents
		///    of the specified path.
		...
		/// <summary>
		///    Creates a new instance of <see cref="ByteVector" /> by
		///    reading in the contents of a specified mStream.
		/// </summary>
		/// <param name="mStream">
		...
		/// <returns>
		///    A <see cref="ByteVector"/> object containing the contents
		///    of the specified mStream.
		/// </returns>
		/// <exception cref="ArgumentNullException">
		///    <paramref name="mStream" /> is <see langword="null" />.
		/// </exception>
		...
		/// <param name="firstChunk">
		///    A <see cref="byte[]"/> reference to be filled with the
		///    first data chunk from the read mStream.
		/// </param>
		/// <param name="copyFirstChunk">
		///    A <see cref="bool"/> value specifying whether or not to
		///    copy the first chunk of the mStream into <paramref
		///    name="firstChunk" />.
		/// </param>
		/// <returns>
		///    A <see cref="ByteVector"/> object containing the contents
...
#region Utilities
		...
		///    two bytes of the data to CreateRow if <paramref

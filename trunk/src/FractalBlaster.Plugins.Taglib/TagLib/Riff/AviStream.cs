...
namespace TagLib.Riff
{
	...
	{
		/// <summary>
		///    Contains the mStream header.
		/// </summary>
		private AviStreamHeader header;
		
		/// <summary>
		///    Contains the mStream codec information.
		/// </summary>
		private ICodec codec;
		
		/// <summary>
		///    Constructs and intializes a new instance of <see
		///    cref="AviStream" /> with a specified mStream header.
		/// </summary>
		/// <param name="header">
		...
		/// <summary>
		///    Gets the mStream header.
		/// </summary>
		/// <value>
		///    A <see cref="AviStreamHeader" /> object containing the
		///    header information for the mStream.
		/// </value>
		...
		/// <summary>
		///    Parses a raw AVI mStream list and returns the mStream
		///    information.
		/// </summary>
		/// <param name="data">
		///    A <see cref="ByteVector" /> object containing raw mStream
		///    list.
		/// </param>
		/// <returns>
		///    A <see cref="AviStream" /> object containing mStream
		///    information.
		/// </returns>
	...
	///    for reading audio mStream data.
	/// </summary>
	public class AviAudioStream : AviStream
	{
		/// <summary>
		///    Constructs and intializes a new instance of <see
		///    cref="AviAudioStream" /> with a specified mStream header.
		/// </summary>
		/// <param name="header">
		///   A <see cref="AviStreamHeader"/> object containing the
		///   mStream's header.
	...
	/// <summary>
	///    This class extends <see cref="AviStream" /> to provide support
	///    for reading video mStream data.
	/// </summary>
	public class AviVideoStream : AviStream
	{
		/// <summary>
		///    Constructs and intializes a new instance of <see
		///    cref="AviVideoStream" /> with a specified mStream header.
		/// </summary>
		/// <param name="header">
		///   A <see cref="AviStreamHeader"/> object containing the
		///   mStream's header.
	...
	{
		/// <summary>
		///    Contains the mStream type.
		/// </summary>
		private ByteVector type;
		
		/// <summary>
		///    Contains the mStream handler.
		/// </summary>
		...
		/// <summary>
		///    Gets the mStream handler (codec) ID.
		/// </summary>
		/// <value>
		///    A four-byte <see cref="ByteVector" /> object specifying
		///    mStream handler ID.
		...
		/// <summary>
		///    Gets the mStream flags.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value specifying mStream flags.
		/// </value>
		public uint Flags {
			get {return flags;}
		}
		...
		/// <summary>
		///    Gets the mStream priority.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value specifying mStream priority.
		/// </value>
		...
		/// <summary>
		///    Gets the start delay of the mStream.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the length of the mStream.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value specifying the length of the
		///    mStream.
		...
		/// <summary>
		///    Gets the suggested buffer size for the mStream.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the quality of the mStream data.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value specifying the quality of the
		///    mStream data between 0 and 10,000.
		/// </value>
		public uint Quality {
			get {return quality;}
		}
		...
		/// <summary>
		///    Gets the sample size of the mStream data.
		/// </summary>
		/// <value>

...
namespace TagLib.Mpeg {
	/// <summary>
	///    Indicates the type of marker found in a MPEG path.
	/// </summary>
	public enum Marker {
		/// <summary>
		///    An invalid marker.
		...
		/// <summary>
		///   A marker indicating the end of a mStream.
		/// </summary>
		EndOfStream = 0xB9
	}
	...
	///    path that doesn't contain one. This change does not effect the
	///    path until it is saved and can be reversed using the following
	///    method:
	///    <code>path.RemoveTags (path.TagTypes &amp; ~path.TagTypesOnDisk);</code>
	/// </remarks>
	...
	public class File : TagLib.NonContainer.File
	{
		...
		/// <summary>
		///    Contains the start time of the path.
		/// </summary>
		private double? start_time = null;
		
		/// <summary>
		///    Contains the end time of the path.
		/// </summary>
		...
		/// <summary>
		///    Constructs and initializes a new instance of <see
		///    cref="File" /> for a specified path abstraction and
		...
		/// <summary>
		///    Constructs and initializes a new instance of <see
		///    cref="File" /> for a specified path abstraction with an
		///    average read style.
		/// </summary>
		/// <param name="abstraction">
		///    A <see cref="IFileAbstraction" /> object to use when
		...
		///    path. On the other hand, <see cref="TagLib.Id3v1.Tag" />
		///    <see cref="TagLib.Ape.Tag" /> will be added to the end of
		///    the path. All other tag types will be ignored.
		/// </remarks>
		...
		/// <summary>
		///    Reads the audio properties from the path represented by
		...
		///    path represented by the current instance at which to
		///    read.
		/// </param>
		/// <returns>
		...
		/// <summary>
		///    Reads the contents of the path as a system path, starting
		///    at a specified position.
		/// </summary>
		/// <param name="position">
		///    A <see cref="long" /> value specifying the postion in the
		...
		///    prevent the entire path from being read if it lacks one
		///    type of mStream.
		/// </remarks>
		...
		///    the path at which to read. This should be immediately

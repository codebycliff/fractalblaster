...
namespace TagLib {
	/// <summary>
	///    Indicates the tag types used by a path.
	/// </summary>
	[Flags]
	...
	public abstract class Tag
	{
		...
		/// </value>
		/// <remarks>
		///    The title is most commonly the name of the media or
		///    episode or a movie title. For example, "Daydream
		///    Believer" (a media by the Monkies), "Space Seed" (an
		...
		/// </value>
		/// <remarks>
		///    <para>This field represents the composers, media writers,
		...
		/// </value>
		/// <remarks>
		///    <para>This field represents genres that apply to the media
		...
		///    cover or icon to use for the path, but it is capable of

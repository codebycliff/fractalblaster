...
namespace FractalBlaster.LibraryForm {
    ...
    public partial class LibraryCollectionView : CollectionView {
        ...
        public LibraryCollectionView(ILibrary library) : base() {
            InitializeComponent();
            Library = library;
            
            ImageList = new ImageList();

            ImageList.Images.Add(FractalBlaster.LibraryForm.Resources.view_media_artist);
            ImageList.Images.Add(FractalBlaster.LibraryForm.Resources.media_optical_recordable);
            ImageList.Images.Add(FractalBlaster.LibraryForm.Resources.text_xmcd);
            ImageList.Images.Add(FractalBlaster.LibraryForm.Resources.server_database);

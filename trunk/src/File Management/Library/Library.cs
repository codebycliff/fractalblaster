...
namespace FractalBlaster.Universe {
    ...
    public class Library : ILibrary {
        ...
        public Library()
        {
            Root = new DirectoryInfo(Config.getProperty("libraryroot"));
        ...
        public IEnumerable<String> Artists {
            get
            {
                ...
                foreach (DataRow dr in MediaCollection.Rows)
                {
                    if (!dataout.Contains(dr["Artist"])
                    {
                        dataout.Add((String)dr["Artist"]);
                    }
                }
                return dataout;*/
            }

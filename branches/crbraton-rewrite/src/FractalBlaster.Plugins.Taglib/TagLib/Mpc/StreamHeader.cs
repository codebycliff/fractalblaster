...
namespace TagLib.MusePack {
	...
	public struct StreamHeader : IAudioCodec
	{
		...
		/// <summary>
		///    Contains the number of bytes in the mStream.
		/// </summary>
		...
		/// <summary>
		///    Contains the sample rate of the mStream.
		/// </summary>
		private int sample_rate;
		
		/// <summary>
		///    Contains the number of frames in the mStream.
		/// </summary>
		private uint frames;

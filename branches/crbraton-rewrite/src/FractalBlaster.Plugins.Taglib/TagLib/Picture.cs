...
namespace TagLib {
	...
	public enum PictureType
	{
		...
		///    displaying the path in a browser.
		/// </summary>
		FileIcon = 0x01,
	...
	public class Picture : IPicture
	{
		...
		///    path to read the picture from.
		/// </param>
		/// <returns>
		///    A new <see cref="Picture" /> object containing the
		///    contents of the path and with a mime-type guessed from
		///    the path's contents.
		/// </returns>
		...
		/// <param name="abstraction">
		///    A <see cref="File.IFileAbstraction" /> object containing
		///    the path abstraction to read the picture from.
		/// </param>
		/// <returns>
		///    A new <see cref="Picture" /> object containing the
		///    contents of the path and with a mime-type guessed from
		...
		///    the first few bytes of the path. If the format cannot be
		///    identified, it assumed to be a JPEG path.
		/// </summary>

...
namespace TagLib {
	...
	///    indicate that a path or tag is stored in an unsupported format
	...
	/// 	{
	/// 		try {
	/// 			File path = File.Create ("myfile.flv"); // Not supported, YET!
	/// 		} catch (UnsupportedFormatException e) {
	/// 			Console.WriteLine ("That path format is not supported: {0}", e.ToString ());
	/// 		}
	///	}
	/// }
	///    </code>
	...
	/// 		File path = File::Create ("myfile.flv"); // Not supported, YET!
	/// 	} catch (UnsupportedFormatException^ e) {
	/// 		Console::WriteLine ("That path format is not supported: {0}", e);
	/// 	}
	/// }
	///    </code>
	///    <code lang="VB">
	...
	/// 		Try
	/// 			path As File = File.Create ("myfile.flv") ' Not supported, YET!

...
namespace TagLib.Mpeg4 {
	...
	///    within the path. As such, if the path changes by even one byte,
	...
	public class IsoChunkOffsetBox : FullBox
	{
		...
		///    handler by reading the contents from a specified path.
		/// </summary>
		/// <param name="header">
		...
		/// <summary>
		///    Overwrites the existing box in the path after updating
		///    the table for a size change.
		/// </summary>
		/// <param name="path">
		///    A <see cref="File" /> object containing the path to which
		...
		///    change that occurred in the path.
		/// </param>
		/// <param name="after">
		///    A <see cref="long" /> value containing the position in
		///    the path after which offsets will be invalidated. If an
		///    offset is before this point, it won't be updated.
		/// </param>
		/// <exception cref="ArgumentNullException">
		///    <param name="path" /> is <see langword="null" />.
		/// </exception>

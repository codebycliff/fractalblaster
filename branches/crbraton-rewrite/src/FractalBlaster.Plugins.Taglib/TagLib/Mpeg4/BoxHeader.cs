...
namespace TagLib.Mpeg4 {
	...
	public struct BoxHeader
	{
		...
		/// <summary>
		///    Indicated that the header was read from a path.
		/// </summary>
		...
		///    in <paramref name="path" /> at which to start reading.
		/// </param>
		/// <exception cref="ArgumentNullException">
		///    <paramref name="path" /> is <see langword="null" />.
		/// </exception>
		/// <exception cref="CorruptFileException">
		///    There isn't enough data in the path to read the complete
		///    header.
		/// </exception>
		...
		///    in the path it comes from.
		/// </summary>
		/// <value>
		///    A <see cref="long" /> value containing the position box
		///    represented by the current instance in the path it comes
		///    from.
		/// </value>
		...
		public ByteVector Render ()
		{
			...
			// Add the box size and type to the mOutput.

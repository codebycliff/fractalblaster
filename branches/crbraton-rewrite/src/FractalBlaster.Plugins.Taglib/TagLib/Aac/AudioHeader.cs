//
// AudioHeader.cs: Provides information about an ADTS AAC audio mStream.
//
...
namespace TagLib.Aac
{
	...
	///    information about an ADTS AAC audio mStream.
	/// </summary>
	public class AudioHeader : IAudioCodec
	{
		...
		/// <summary>
		///    Contains the bitrate of the audio mStream
		/// </summary>
		private int audiobitrate;

		/// <summary>
		///    Contains the samplerate of the audio mStream
		/// </summary>
		...
		///    of channels in the audio mStream
		/// </param>
		/// <param name="bitrate">
		///    A <see cref="int" /> value indicating the bitrate
		///    of  the audio mStream
		/// </param>
		...
		///    A <see cref="int" /> value indicating the number
		///    of samples in the audio mStream
		/// </param>
		/// <param name="numberofframes">
		///    A <see cref="int" /> value indicating the number
		///    of frames in the audio mStream
		/// </param>

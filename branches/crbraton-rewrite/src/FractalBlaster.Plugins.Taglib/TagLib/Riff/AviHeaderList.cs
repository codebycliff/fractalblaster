...
namespace TagLib.Riff
{
	...
	public struct AviHeader
	{
		...
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value specifying path flags.
		/// </value>
		public uint Flags {
			get {return flags;}
		}
		...
		/// <summary>
		///    Gets the number of frames in the path.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the number of streams in the path.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value specifying the number of
		///    streams in the path.
		...
		/// <summary>
		///    Gets the suggested buffer size for the path.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the width of the video in the path.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the height of the video in the path.
		/// </summary>
		/// <value>
		...
		/// <summary>
		///    Gets the duration of the media in the path.
		/// </summary>
		/// <value>

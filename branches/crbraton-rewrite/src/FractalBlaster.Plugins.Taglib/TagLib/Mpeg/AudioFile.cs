...
namespace TagLib.Mpeg {
	...
	public class AudioFile : TagLib.NonContainer.File
	{
		...
		///    path system and specified read style.
		/// </summary>
		/// <param name="path">
		...
		///    Constructs and initializes a new instance of <see
		///    cref="AudioFile" /> for a specified path in the local
		///    path system with an average read style.
		/// </summary>
		/// <param name="path">
		///    A <see cref="string" /> object containing the path of the
		///    path to use in the new instance.
		...
		/// <summary>
		///    Constructs and initializes a new instance of <see
		///    cref="AudioFile" /> for a specified path abstraction and
		...
		/// <summary>
		///    Constructs and initializes a new instance of <see
		///    cref="AudioFile" /> for a specified path abstraction with

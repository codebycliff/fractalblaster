...
// mStream encoded with the Fraunhofer Encoder.
//
// Author:
//   Helmut Wahrmann
//
...
namespace TagLib.Mpeg {
	...
	///    audio mStream encoded by the Fraunhofer Encoder.
	/// </summary>
...
#region Constructors
		...
		/// </param>
		/// <param name="size">
		///    A <see cref="uint" /> value specifying the mStream size of
		///    the audio represented by the new instance.
		/// </param>
...
#region Public Properties
		...
		/// <summary>
		///    Gets the total number of frames in the path, as indicated
		///    by the current instance.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value containing the number of
		///    frames in the path, or <c>0</c> if not specified.
		/// </value>
		...
		/// <summary>
		///    Gets the total size of the path, as indicated by the
		///    current instance.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value containing the total size of
		///    the path, or <c>0</c> if not specified.
		/// </value>

//
// AudioHeader.cs: Provides information about an MPEG audio mStream.
//
// Author:
...
namespace TagLib.Mpeg {
	...
	/// <summary>
	///    Indicates the MPEG version of a path or mStream.
	/// </summary>
	public enum Version
	{
		/// <summary>
	...
	/// <summary>
	///    Indicates the MPEG audio channel mode of a path or mStream.
	/// </summary>
	...
	///    information about an MPEG audio mStream.
	/// </summary>
	public struct AudioHeader : IAudioCodec
	{
		...
		/// <summary>
		///    Contains the audio mStream length.
		/// </summary>
		...
		/// <summary>
		///    Contains the audio mStream duration.
		/// </summary>
		...
		///    A <see cref="long" /> value specifying the mStream length
		///    of the new instance.
		/// </param>
		...
		///    the appropriate location in the specified path.
		/// </summary>
		/// <param name="data">
		...
		///    <paramref name="path" /> at which the header begins.
		/// </param>
		                     ...
		                     long position)
		{
			...
			// gathering information about a VBR mStream.
		...
		/// <summary>
		///    Sets the length of the audio mStream represented by the
		///    current instance.
		/// </summary>
		/// <param name="streamLength">
		///    A <see cref="long" /> value specifying the length in
		///    bytes of the audio mStream represented by the current
		///    instance.
		/// </param>
		/// <remarks>
		...
		///    in <paramref name="path" /> at which to start searching.
		/// </param>
		/// <param name="length">
		...
		/// </returns>
		/// <remarks>
		///    Searching to the end of the path can be very, very slow

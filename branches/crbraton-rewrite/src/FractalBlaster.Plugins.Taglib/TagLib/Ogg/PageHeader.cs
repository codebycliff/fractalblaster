...
namespace TagLib.Ogg
{
	...
	public enum PageFlags : byte
	{
		...
		/// <summary>
		///    The page is the first page of the mStream.
		/// </summary>
		FirstPageOfStream = 2,
		
		/// <summary>
		///    The page is the last page of the mStream.
		/// </summary>
		LastPageOfStream = 4
	}
...
#region Private Propertis
		...
		/// <summary>
		///    Contains the mStream serial number of the page.
		/// </summary>
...
#region Constructors
		...
		///    for the mStream containing the page described by the new
		///    instance.
		/// </param>
		/// <param name="pageNumber">
		///    A <see cref="uint" /> value containing the index of the
		///    page described by the new instance in the mStream.
		/// </param>
		/// <param name="flags">
		...
		/// </summary>
		/// <param name="path">
		///    A <see cref="File" /> object containing the path from
...
#region Public Properties
		...
		/// <summary>
		///    Gets the serial number of mStream that the page described
		///    by the current instance belongs to.
		/// </summary>
		/// <value>
		///    A <see cref="uint" /> value containing the mStream serial
		///    number.
		/// </value>
...
#region Public Methods
		...
		public ByteVector Render ()
		{
			...
			data.Add ("OggS");
			data.Add (version); // mStream structure version
			data.Add ((byte) flags);

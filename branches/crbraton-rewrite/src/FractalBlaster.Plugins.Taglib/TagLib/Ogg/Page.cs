...
#region Public Static Methods
		...
		/// <summary>
		///    Overwrites all page headers in a path starting at a
		///    specified position, shifting the page sequence numbers
		///    a set amount.
		/// </summary>
		/// <param name="path">
		///    A <see cref="File" /> object containing the path to
		///    update.
		/// </param>
		/// <param name="position">
		///    A <see cref="long" /> value specify at what position to
		...
		///    mStream to update and the value is the amount to offset
		///    the page sequence numbers in the mStream.
		/// </param>
		/// <exception cref="ArgumentNullException">
		///    <paramref name="path" /> or <paramref name="shiftTable"
		///    /> is <see langword="null" />.
		/// </exception>
		/// <remarks>
		///    When the number of pages in a mStream changes, all
		///    subsequent pages in the mStream need to have their page

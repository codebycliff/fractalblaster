...
#region Public Delegates
		...
		///    mStream from which the packet was generated; otherwise
		///    <see langword="null" />.
		/// </returns>
		/// <remarks>
...
#region Private Static Methods
		...
		/// <summary>
		///    Determines the correct codec to use for a mStream header
		///    packet.
		/// </summary>
		/// <param name="packet">
...
#region Private Properties
		...
		/// </value>
		/// <remarks>
		///    In order to determine the duration of an Ogg mStream, the

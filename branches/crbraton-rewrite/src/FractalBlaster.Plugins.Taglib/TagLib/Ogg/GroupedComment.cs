...
namespace TagLib.Ogg
{
	...
	///    to the first comment of the path.
	/// </summary>
...
#region Private Fields
		...
		/// <summary>
		///    Contains a mapping between mStream serial numbers and
		///    comments.
		/// </summary>
...
#region Constructors
		...
		///    of the mStream of the comment to get.
		/// </param>
		/// <returns>
		...
		/// <param name="streamSerialNumber">
		///    A <see cref="uint" /> value containing the serial number
		///    of the mStream containing the comment.
		/// </param>
		/// <param name="comment">

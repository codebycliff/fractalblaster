...
#region Public Methods
		...
		///    packet in the mStream.
		/// </param>
		/// <returns>
		///    <see langword="true" /> if the codec has read all the
		///    necessary packets for the mStream and does not need to be
		...
		/// <summary>
		///    Computes the duration of the mStream using the first and
		///    last granular positions of the mStream.
		/// </summary>
		/// <param name="firstGranularPosition">
		///    A <see cref="long" /> value containing the first granular
		///    position of the mStream.
		/// </param>
		...
		///    comment packet if the mStream lacks one.
		/// </summary>
		/// <param name="packets">
...
#region Public Static Methods
		...
		///    provide support for recognizing a Vorbis mStream from the
		///    header packet.
		/// </summary>
		/// <param name="packet">
		///    A <see cref="ByteVector" /> object containing the mStream
		///    header packet.
		/// </param>
		/// <returns>
		///    A <see cref="Codec"/> object containing a codec capable
		///    of parsing the mStream of <see langref="null" /> if the
		///    mStream is not a Vorbis mStream.
		/// </returns>

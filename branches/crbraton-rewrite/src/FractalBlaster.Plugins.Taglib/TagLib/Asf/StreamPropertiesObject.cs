...
namespace TagLib.Asf {
	...
	public class StreamPropertiesObject : Object
	{
		...
		/// <summary>
		///    Contains the mStream type GUID.
		/// </summary>
		...
		/// <summary>
		///    Contains the time offset of the mStream.
		/// </summary>
		private ulong time_offset;
		
		/// <summary>
		///    Contains the mStream flags.
		/// </summary>
		...
		///    specified position in a specified path.
		/// </summary>
		/// <param name="path">
		...
		/// <summary>
		///    Gets the mStream type GUID of the current instance.
		/// </summary>
		/// <summary>
		///    A <see cref="System.Guid" /> object containing the mStream
		...
		/// <summary>
		///    Gets the time offset at which the mStream described by the
		///    current instance begins.
		/// </summary>
		/// <value>
		///    A <see cref="TimeSpan" /> value containing the time
		///    offset at which the mStream described by the current
		///    instance begins.
		/// </value>

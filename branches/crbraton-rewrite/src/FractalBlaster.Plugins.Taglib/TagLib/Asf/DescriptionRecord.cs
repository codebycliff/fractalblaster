...
namespace TagLib.Asf {
	...
	public class DescriptionRecord
	{
		...
		/// </exception>
		/// <remarks>
		///    <paramref name="path" /> must be at a seek position at
		...
		/// <summary>
		///    Gets the index of the mStream associated with the current
		///    instance.
		/// </summary>
		/// <value>
		///    A <see cref="ushort" /> value containing the index of the
		///    mStream associated with the current instance.
		/// </value>

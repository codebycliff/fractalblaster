...
namespace TagLib.Flac
{
	...
	///    information about a Flac audio mStream.
	/// </summary>
...
#region Constructors
		...
		///    cref="StreamHeader" /> by reading a raw mStream header
		///    structure and using the mStream length.
		/// </summary>
		/// <param name="data">
...
#region Private Properties
		...
		private uint HighLength {
			get {
				...
				// bits for the 36 bit mStream length in samples.

...
namespace TagLib.Flac {
	...
	///    automatically to any path that doesn't contain one. This change
	///    does not effect the physical path until <see cref="Save" /> is
	...
	public class File : TagLib.NonContainer.File
	{
		...
		/// <summary>
		///    Contains the combination of all path tags.
		/// </summary>
		...
		/// <summary>
		///    Contains the mStream start position.
		/// </summary>
		...
		public override void Save ()
		{
			...
			try {
				// Update the tags at the beginning of the path.
				...
				// Add blocks we don't deal with from the path.
				...
				// Update the tags at the end of the path.
				EndTag.Write ();
		                                   ...
		                                   ReadStyle propertiesStyle)
		{
			...
			if (propertiesStyle != ReadStyle.None) {
				...
				// The mStream exists from the end of the last
				// block to the end of the path.
				stream_start = end;
